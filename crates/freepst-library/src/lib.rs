...
//! into separate crates (`freepst-eval`, `freepst-realize`, `freepst-layout`, etc.)
//!
...
extern crate self as freepst_library;
...
use freepst_syntax::{FileId, Source, Span};
use freepst_utils::{LazyHash, SmallBitSet};
