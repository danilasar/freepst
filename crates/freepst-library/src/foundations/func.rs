...
use freepst_syntax::{ast, Span, SyntaxNode};
use freepst_utils::{singleton, LazyHash, Static};
...
impl Func {
    ...
    #[freepst_macros::time(name = "func call", span = self.span())]
    fn call_impl(
        &self,
        engine: &mut Engine,
        context: Tracked<Context>,
