...
impl Tag {
    ...
    pub fn tm_scope(&self) -> &'static str {
        match self {
            Self::Comment => "comment.freepst",
            Self::Punctuation => "punctuation.freepst",
            Self::Escape => "constant.character.escape.freepst",
            Self::Strong => "markup.bold.freepst",
            Self::Emph => "markup.italic.freepst",
            Self::Link => "markup.underline.link.freepst",
            Self::Raw => "markup.raw.freepst",
            Self::MathDelimiter => "punctuation.definition.math.freepst",
            Self::MathOperator => "keyword.operator.math.freepst",
            Self::Heading => "markup.heading.freepst",
            Self::ListMarker => "punctuation.definition.list.freepst",
            Self::ListTerm => "markup.list.term.freepst",
            Self::Label => "entity.name.label.freepst",
            Self::Ref => "markup.other.reference.freepst",
            Self::Keyword => "keyword.freepst",
            Self::Operator => "keyword.operator.freepst",
            Self::Number => "constant.numeric.freepst",
            Self::String => "string.quoted.double.freepst",
            Self::Function => "entity.name.function.freepst",
            Self::Interpolated => "meta.interpolation.freepst",
            Self::Error => "invalid.freepst",
        }
    }
