...
use freepst_library::foundations::{Context, Packed, Smart, StyleChain};
use freepst_library::layout::{Abs, Angle, Frame, FrameItem, Point, Rel, Size, Transform};
use freepst_library::math::{CancelAngle, CancelElem};
...
#[freepst_macros::time(name = "math.cancel", span = elem.span())]
