...
use freepst_library::foundations::{Packed, StyleChain};
use freepst_library::layout::{Abs, Axis, Corner, Frame, Point, Rel, Size};
...
#[freepst_macros::time(name = "math.attach", span = elem.span())]
...
#[freepst_macros::time(name = "math.primes", span = elem.span())]
...
#[freepst_macros::time(name = "math.scripts", span = elem.span())]
...
#[freepst_macros::time(name = "math.limits", span = elem.span())]
