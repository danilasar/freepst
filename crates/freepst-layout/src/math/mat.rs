...
use freepst_library::math::{Augment, AugmentOffsets, CasesElem, MatElem, VecElem};
use freepst_library::text::TextElem;
use freepst_library::visualize::{FillRule, FixedStroke, Geometry, LineCap, Shape};
...
/// Lays out a [`VecElem`].
#[freepst_macros::time(name = "math.vec", span = elem.span())]
pub fn layout_vec(
    elem: &Packed<VecElem>,
    ctx: &mut MathContext,
    styles: StyleChain,
...
/// Lays out a [`MatElem`].
#[freepst_macros::time(name = "math.mat", span = elem.span())]
pub fn layout_mat(
    elem: &Packed<MatElem>,
    ctx: &mut MathContext,
    styles: StyleChain,
...
#[freepst_macros::time(name = "math.cases", span = elem.span())]
pub fn layout_cases(
