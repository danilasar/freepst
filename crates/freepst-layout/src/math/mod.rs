...
use freepst_library::foundations::{Content, NativeElement, Packed, Resolve, StyleChain};
use freepst_library::introspection::{Counter, Locator, SplitLocator, TagElem};
...
use freepst_library::model::ParElem;
use freepst_library::routines::{Arenas, RealizationKind};
use freepst_library::text::{
...
#[freepst_macros::time(name = "math.op", span = elem.span())]
fn layout_class(
