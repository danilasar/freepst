...
use freepst_library::diag::{warning, SourceResult};
use freepst_library::foundations::{Packed, StyleChain};
use freepst_library::layout::{Abs, Axis, Frame, Point, Rel, Size};
use freepst_library::math::StretchElem;
use freepst_utils::Get;
...
#[freepst_macros::time(name = "math.stretch", span = elem.span())]
