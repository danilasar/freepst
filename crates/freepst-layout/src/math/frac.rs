...
use freepst_library::layout::{Em, Frame, FrameItem, Point, Size};
use freepst_library::math::{BinomElem, FracElem};
...
/// Lays out a [`FracElem`].
#[freepst_macros::time(name = "math.frac", span = elem.span())]
pub fn layout_frac(
...
#[freepst_macros::time(name = "math.binom", span = elem.span())]
pub fn layout_binom(
