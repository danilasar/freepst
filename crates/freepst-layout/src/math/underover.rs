...
use freepst_library::foundations::{Content, Packed, Resolve, StyleChain};
use freepst_library::layout::{Abs, Em, FixedAlignment, Frame, FrameItem, Point, Size};
use freepst_library::math::{
...
use freepst_library::text::TextElem;
use freepst_library::visualize::{FixedStroke, Geometry};
...
#[freepst_macros::time(name = "math.underline", span = elem.span())]
...
#[freepst_macros::time(name = "math.overline", span = elem.span())]
...
#[freepst_macros::time(name = "math.underbrace", span = elem.span())]
...
#[freepst_macros::time(name = "math.overbrace", span = elem.span())]
...
#[freepst_macros::time(name = "math.underbracket", span = elem.span())]
...
#[freepst_macros::time(name = "math.overbracket", span = elem.span())]
...
#[freepst_macros::time(name = "math.underparen", span = elem.span())]
...
#[freepst_macros::time(name = "math.overparen", span = elem.span())]
...
#[freepst_macros::time(name = "math.undershell", span = elem.span())]
...
#[freepst_macros::time(name = "math.overshell", span = elem.span())]
