use freepst_library::foundations::{Resolve, Smart};
use freepst_library::layout::{Abs, AlignElem, Dir, Em, FixedAlignment};
use freepst_library::model::Linebreaks;
use freepst_library::text::{Costs, Lang, TextElem};
