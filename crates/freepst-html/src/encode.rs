...
use freepst_library::diag::{bail, At, SourceResult, StrResult};
use freepst_library::foundations::Repr;
use freepst_library::html::{charsets, tag, HtmlDocument, HtmlElement, HtmlNode};
use freepst_library::layout::Frame;
...
fn write_frame(w: &mut Writer, frame: &Frame) {
    ...
    let svg = freepst_svg::svg_frame(frame)
