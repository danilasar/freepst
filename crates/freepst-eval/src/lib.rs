...
pub use self::vm::Vm;
pub use freepst_library::routines::EvalMode;
...
use freepst_library::diag::{bail, SourceResult};
use freepst_library::engine::{Engine, Route, Sink, Traced};
use freepst_library::foundations::{Context, Module, NativeElement, Scope, Scopes, Value};
use freepst_library::introspection::Introspector;
use freepst_library::math::EquationElem;
use freepst_library::routines::Routines;
use freepst_library::World;
use freepst_syntax::{ast, parse, parse_code, parse_math, Source, Span};

/// Evaluate a source file and return the resulting module.
#[comemo::memoize]
#[freepst_macros::time(name = "eval", span = source.root().span())]
pub fn eval(
    routines: &Routines,
