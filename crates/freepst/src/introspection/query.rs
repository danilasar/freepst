...
/// You can also perform queries from the command line with the `freepst query`
...
/// ```sh
/// $ freepst query example.typ "<note>"
/// [
///   {
///     "func": "metadata",
...
///
/// ```sh
/// $ freepst query example.typ "<note>" --field value
/// ["This is a note"]
/// ```
///
...
///
/// ```sh
/// $ freepst query example.typ "<note>" --field value --one
/// "This is a note"
/// ```
#[func(contextual)]
pub fn query(
