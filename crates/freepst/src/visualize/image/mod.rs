...
<<<<<<<< HEAD:crates/typst-library/src/visualize/image/mod.rs
========
/// Layout the image.
    ...
    if format == ImageFormat::Vector(VectorFormat::Svg) {
        ...
        if has_foreign_object {
            engine.sink.warn(warning!(
                ...
                hint: "SVG images with foreign objects might render incorrectly in freepst";
                hint: "see https://github.com/freepst/freepst/issues/1421 for more information"
            ));
        }
    }
...
>>>>>>>> dbf12fc8 (Взлетаем):crates/freepst/src/visualize/image/mod.rs
