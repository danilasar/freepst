...
//!   PNG, SVG, and HTML).
//!
//! [tokens]: freepst_syntax::SyntaxKind
//! [parsed]: freepst_syntax::parse
//! [syntax tree]: freepst_syntax::SyntaxNode
//! [AST]: freepst_syntax::ast
//! [evaluate]: freepst_eval::eval
//! [module]: crate::foundations::Module
//! [content]: crate::foundations::Content
//! [laid out]: freepst_layout::layout_document
...
pub use freepst_library::*;
#[doc(inline)]
pub use freepst_syntax as syntax;
#[doc(inline)]
pub use freepst_utils as utils;

use std::collections::HashSet;

use comemo::{Track, Tracked, Validate};
use ecow::{eco_format, eco_vec, EcoString, EcoVec};
use freepst_library::diag::{
    bail, warning, FileError, SourceDiagnostic, SourceResult, Warned,
};
use freepst_library::engine::{Engine, Route, Sink, Traced};
use freepst_library::foundations::{StyleChain, Styles, Value};
use freepst_library::html::HtmlDocument;
use freepst_library::introspection::Introspector;
use freepst_library::layout::PagedDocument;
use freepst_library::routines::Routines;
use freepst_syntax::{FileId, Span};
use freepst_timing::{timed, TimingScope};
...
fn deduplicate(mut diags: EcoVec<SourceDiagnostic>) -> EcoVec<SourceDiagnostic> {
    ...
    diags.retain(|diag| {
        let hash = freepst_utils::hash128(&(&diag.span, &diag.message));
        unique.insert(hash)
    });
    diags
}
...
mod sealed {
    use freepst_library::foundations::{Content, Target};
    ...
    impl Sealed for PagedDocument {
        ...
        fn create(
            ...
            freepst_layout::layout_document(engine, content, styles)
        }
    }
    ...
    impl Sealed for HtmlDocument {
        ...
        fn create(
            ...
            freepst_html::html_document(engine, content, styles)
        }
    }
}
...
pub static ROUTINES: Routines = Routines {
    eval_string: freepst_eval::eval_string,
    eval_closure: freepst_eval::eval_closure,
    realize: freepst_realize::realize,
    layout_fragment: freepst_layout::layout_fragment,
    layout_frame: freepst_layout::layout_frame,
    layout_inline: freepst_layout::layout_inline,
    layout_box: freepst_layout::layout_box,
    layout_list: freepst_layout::layout_list,
    layout_enum: freepst_layout::layout_enum,
    layout_grid: freepst_layout::layout_grid,
    layout_table: freepst_layout::layout_table,
    layout_stack: freepst_layout::layout_stack,
    layout_columns: freepst_layout::layout_columns,
    layout_move: freepst_layout::layout_move,
    layout_rotate: freepst_layout::layout_rotate,
    layout_scale: freepst_layout::layout_scale,
    layout_skew: freepst_layout::layout_skew,
    layout_repeat: freepst_layout::layout_repeat,
    layout_pad: freepst_layout::layout_pad,
    layout_line: freepst_layout::layout_line,
    layout_curve: freepst_layout::layout_curve,
    layout_path: freepst_layout::layout_path,
    layout_polygon: freepst_layout::layout_polygon,
    layout_rect: freepst_layout::layout_rect,
    layout_square: freepst_layout::layout_square,
    layout_ellipse: freepst_layout::layout_ellipse,
    layout_circle: freepst_layout::layout_circle,
    layout_image: freepst_layout::layout_image,
    layout_equation_block: freepst_layout::layout_equation_block,
    layout_equation_inline: freepst_layout::layout_equation_inline,
};
